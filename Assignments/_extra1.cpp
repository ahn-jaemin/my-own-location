...
double solveQuadratic(double a, double b, double c, double valDiscr, int var){            //?
    double valSolution;

    valSolution = (-b + var * sqrt(valDiscr)) / (2 * a);
...
int main(){
    ...
    if (valDiscr > 0){
        sol1 = solveQuadratic(a, b, c, valDiscr, 1);
        sol2 = solveQuadratic(a, b, c, valDiscr, -1);
