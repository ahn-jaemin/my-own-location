...
void removeDuplicates(vector<string> &vec1) { ////& pass by reference       
    ...
    /*for (int i = 0; i < vec1.size(); ++i){      //DEBUG
        std::cout << vec1.at(i) << std::endl;
    }*/
}

vector <string> delimitString (string sentence){  ////Typo but shouldn't be a problem.
